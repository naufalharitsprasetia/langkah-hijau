    ...
    <div class="hero z-10 transition-colors duration-300">
        <div class="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-24 px-4">
            <h1
                ...
                <span class="text-hijautua dark:text-hijaumuda">Tentang Aplikasi</span>
            </h1>
        </div>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="animate-fade-in">
                        ...
                        <p class="text-gray-600 dark:text-gray-300 text-lg mb-8 leading-relaxed">
                            Isu lingkungan hidup dan kesehatan masyarakat saat ini menjadi tantangan global yang semakin
                            mendesak.
                            ...
                            yang menarik dan relevan dengan kebiasaan digital mereka. Di sinilah peran teknologi digital
                        ...
                        <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-8 text-left">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 dark:text-gray-400">Mengaku kurang memahami dampak lingkungan
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div
                        ...
                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
                            Jika dilakukan secara kolektif dan konsisten, aksi-aksi sederhana sehari-hari memiliki potensi besar untuk membawa perubahan positif terhadap lingkungan dan kebiasaan hidup masyarakat.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 lg:py-24 duration-300 relative isolate">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    <div class="relative animate-fade-in">
                        <img src="{{ asset('img/tentang/reusable.png') }}"
                            alt="Professional Woman with Laptop" class="rounded-2xl shadow-2xl w-full h-auto">
                    </div>
        
                    <div class="animate-fade-in">
                        <span class="inline-block bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200 px-3 py-1 rounded-full text-sm font-medium mb-4 shadow-[0_0_10px_rgba(34,197,94,0.5)]">
                            THE OBJECTIVE
                        </span>
        
                        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 text-black dark:text-white">Tujuan dan Fungsi</h2>
                        <p class="text-black dark:text-gray-300 text-lg mb-8 leading-relaxed">
                            LangkahHijau dikembangkan sebagai solusi edukatif dan interaktif untuk mengubah aktivitas harian menjadi aksi positif bagi kesehatan dan lingkungan melalui pendekatan gamifikasi. Aplikasi ini bertujuan untuk:
                        </p>
        
                        <div class="space-y-6">
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0 w-12 h-12 bg-white/20 dark:bg-white/10 rounded-lg flex items-center justify-center text-green-800 dark:text-green-300">
                                    <i class="fas fa-users text-xl"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-semibold mb-2 text-green-800 dark:text-green-300">Meningkatkan Literasi Lingkungan dan Kesehatan</h3>
                                    <p class="text-black dark:text-gray-300">Membangun kesadaran masyarakat tentang pentingnya hidup sehat dan ramah lingkungan melalui pendekatan edukatif yang relevan dan mudah dipahami.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-semibold mb-2 text-green-800 dark:text-green-300">Edukasi Digital Interaktif</h3>
                                    <p class="text-black dark:text-gray-300">Menyediakan platform pembelajaran berbasis digital yang menyenangkan dan dapat diakses kapan saja, di mana saja oleh semua kalangan.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-semibold mb-2 text-green-800 dark:text-green-300">Dorongan Aksi Berkelanjutan</h3>
                                    <p class="text-black dark:text-gray-300">Mengajak pengguna terlibat dalam tantangan, kuis, dan sistem penghargaan sebagai pemicu aksi nyata yang berdampak positif terhadap lingkungan.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="text-xl font-semibold mb-2 text-green-800 dark:text-green-300">Komunitas Hijau yang Menginspirasi</h3>
                                    <p class="text-black dark:text-gray-300">Membangun ekosistem digital yang mendukung interaksi dan kolaborasi antar pengguna dalam gerakan gaya hidup hijau dan sehat.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <a href="{{ route('challenges.index') }}">
                        <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-xl text-center transition-transform transform hover:scale-105 duration-300">
                            <div class="text-green-500 text-4xl mb-4">
                                <i class="fas fa-leaf"></i>
                            </div>
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Tantangan Hijau</h3>
                            <p class="text-gray-600 dark:text-gray-300">
                                Misi aksi nyata seperti hemat listrik, zero waste, dan aktivitas fisik yang bisa dicatat dan diukur rutin.
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="">
                        <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-xl text-center transition-transform transform hover:scale-105 duration-300">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                Kuis harian ringan dan informatif untuk menguji pengetahuan seputar lingkungan dan kesehatan.
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('user.leaderboard') }}">
                        <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-xl text-center transition-transform transform hover:scale-105 duration-300">
                            ...
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Green Points & Badge</h3>
                            <p class="text-gray-600 dark:text-gray-300">
                                Raih poin dan badge eksklusif sebagai apresiasi atas setiap aksi hijau yang kamu lakukan.
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('event.index') }}">
                        <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-xl text-center transition-transform transform hover:scale-105 duration-300">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                Temukan dan ikuti acara lingkungan. Tambahkan ke Google Calendar dan ajukan event milikmu sendiri.
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="{{ route('user.leaderboard') }}">
                        <div class="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-xl text-center transition-transform transform hover:scale-105 duration-300">
                            ...
                            <p class="text-gray-600 dark:text-gray-300">
                                Lihat peringkatmu dan tingkatkan tier mingguan berdasarkan akumulasi Green Points yang dikumpulkan.
                            </p>
                        </div>
                    </a>
